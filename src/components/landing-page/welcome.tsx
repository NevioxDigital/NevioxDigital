  ...
  return (
    <div className="flex h-screen flex-col bg-welcome pb-8 md:pb-64">
      ...
      <div className="max-w-lg text-center mx-auto mt-48 md:mt-64">
        ...
        <p className="mt-8 md:mt-16 font-body text-3xl md:text-5xl font-bold w-full">At Neviox Digital, we are focused on delivering an effective, modern, and robust product adapted to everyones capabilities!</p>
      </div>
    </div>
  );
};
